		...
		)
		{
			...
			foreach ($fields as $propertyCode => $propertyValues)
			{
				if (isset($properties[$propertyCode]))
				{
					...
					if ($properties[$propertyCode]["PROPERTY_TYPE"] === "L")
					{
						$value = new ElementPropertyEnum($propertyValues);
					}
					elseif ($properties[$propertyCode]["PROPERTY_TYPE"] === "E")
					{
					...
					elseif ($properties[$propertyCode]["PROPERTY_TYPE"] === "G")
					{
					...
					{
						if(strlen($properties[$propertyCode]["USER_TYPE"]))
						{
							$value = new ElementPropertyUserField($propertyValues, $properties[$propertyCode]);
						}
						else
						{
							$value = $propertyValues;

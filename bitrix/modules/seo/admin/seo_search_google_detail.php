...
$aTabs = array(
	...
	array("DIV" => "seo_info2", "TAB" => Loc::getMessage('SEO_DETAIL_KEYWORDS'), "ICON" => "main_settings", "TITLE" => Loc::getMessage('SEO_DETAIL_KEYWORDS_TITLE', array('#DOMAIN#' => $siteDomainEnc)), 'ONSELECT' => 'window.BXLoadInfo(\'keywords\')'),
	array("DIV" => "seo_info3", "TAB" => Loc::getMessage('SEO_DETAIL_CRAWL_ISSUES'), "ICON" => "main_settings", "TITLE" => Loc::getMessage('SEO_DETAIL_CRAWL_ISSUES_TITLE', array('#DOMAIN#' => $siteDomainEnc)), 'ONSELECT' => 'window.BXLoadInfo(\'crawlissues\')'),
);
...
?>
<tr>
	<td colspan="2"><?=BeginNote(),Loc::getMessage('SEO_ERROR_NO_INFO', array("#DOMAIN#" => $siteDomainEnc)),EndNote()?></td>
</tr>
<?
}
